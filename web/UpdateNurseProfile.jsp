...
<title>Nurse profile -COVID19</title>
<!-- Bootstrap -->
		...
		<div class="row">
			...
			<div class="col-md-2 menucontent">
				...
				<ul class="nav nav-pills nav-stacked">
					<li role="presentation"><a href="afterNurseLogin.jsp">My schedule</a></li>
					<li role="presentation"><a href="UpdateNurseProfile.jsp">Update Profile</a></li>
				</ul>
			</div>
			<!---- Menu Ares Ends  -------->
			<!---- Content Ares Start  -------->
			<div class="col-md-10 maincontent">
				...
				<div class="panel panel-default contentinside">
					<div class="panel-heading">Edit Nurse Profile</div>
					<!----------------   Panel body Start   --------------->
					<div class="panel-body">
						<ul class="nav nav-tabs nurse">
							<li role="presentation"><a href="#addnurse">Click Here to Edit
									 Nurse Profile</a></li>
						</ul>
						...
						<%
								...
								ResultSet rs = st.executeQuery("select * from nurse where name='" + session.getAttribute("uname") + "'");
								while (rs.next()) {
						%>
						<!----------------   Add Patient Start   --------------->
						<div id="addnurse" class="switchgroup">
							<div class="panel panel-default">
								<div class="panel-body">
									<form class="form-horizontal" action="UpdateNurseInfo"
										method="post">
										<div class="form-group">

											<div class="col-sm-4">
												<input type="hidden" class="form-control" name="nurse_id"
													value="<%=rs.getInt(1)%>">
											</div>
										</div>
										<div class="form-group">
