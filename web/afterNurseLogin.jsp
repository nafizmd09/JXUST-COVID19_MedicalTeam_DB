...
<title>Nurse page [JXUST Medical Team-2022]</title>
<!-- Bootstrap -->
...
<body>
	<div class="container-fluid">
		...
		<div class="row header">
			...
			<div class="col-md-10">
				<h2>JXUST Medical Team [CORONA MOKABELA]</h2>
			</div>
				...
				<div class="panel panel-default contentinside">
					...
					<div class="panel-body">
						<ul class="nav nav-tabs nurse">
							<li role="presentation"><a href="#nurselist">My
									schedule</a></li>
						</ul>

						<!----------------   Display Department Data List start   --------------->

						<div id="nurselist" class="switchgroup">
								...
								<%
									int deptId = 0;
										...
										ResultSet rs = st.executeQuery(
												"select * from appointment where id='" + session.getAttribute("nurse_id") + "' order by day");
										while (rs.next()) {
								%>
